 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class exchange_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        return get_string('event:answered_desc', 'mod_groupexchange', $a);
    }
    ...
    public static function get_name() {
        return get_string('event:answered', 'mod_groupexchange');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'groupexchange', 'choice updated', $logurl, $this->objectid, $this->contextinstanceid);
    }
